...
public class Convert {
    public static int romanToArabic(String sume) throws MyException {
        ...
        else throw new MyException("\"Ты не пройдешь!\" - сказал бы тебе Гендельф, ведь число введенное тобой вне" +
                    " заданного диапазона");
    }
    public static String arabicToRoman(int nume) throws MyException {
        ...
        else throw new MyException("Слишком много получилось! Или слишком мало...");
    }
